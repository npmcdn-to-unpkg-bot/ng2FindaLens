...
@Component({
            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/">Find-A-Lens</a>
                    </div>
    ...
    <!--                    <button type="button" ng-click="" class="btn navbar-btn btn-default pull-right"><a href="/lenses">Lenses</a></button>-->
                        <p class="navbar-text navbar-right"><a ui-sref="lenses-admin" class="navbar-link">View Lenses</a></p>
                    </div>
                    <!-- /.navbar-collapse -->
                </div>
                <!-- /.container -->
            ...
            <div id="content">
                <!-- Angular App Start | Page Content Shows Here -->
                <div class=""></div>
            </div>  <!--  end content -->
